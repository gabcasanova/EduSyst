                ...
                <div id="pagina" class="row justify-content-md-center min-vh-100">
                    ...
                    <div class="col p-3">
                        ...
                        <div class="row mb-5 text-center">
                            <h2>Professores</h2>
                            <a href="ambiente_resp.jsp"><i class="fa-solid fa-arrow-left"></i> Voltar ao ambiente do professor</a>
                        </div>
                        ...
                        <div class="row p-3">
                            <%  if (responsavel != null) {
                                ...
                                try {
                                    ...
                                    String sql = "select distinct professores.Nome, professores.email from professores "
