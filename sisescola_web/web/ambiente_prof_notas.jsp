                        ...
                        <div class="row p-3">
                            <%  if (professor != null) {
                                ...
                                try {
                                    ...
                                    String sql = "select alunos.nome, alunos.email, responsaveis.nome, responsaveis.email, turmas.classe from alunos "
                                    ...
                                    + "where professores.Id_Professor =" + professor.getId() + " order by turmas.classe, alunos.nome asc;";
