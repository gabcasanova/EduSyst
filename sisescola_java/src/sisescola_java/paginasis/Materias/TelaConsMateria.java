 ...
 * @author Aluno
 */
public class TelaConsMateria extends javax.swing.JFrame {
    ...
    public void consultainicial() {
        ...
        try {
            ...
            Logger.getLogger(TelaConsMateria.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        pnlPrincipalCLayout.setHorizontalGroup(
            ...
            .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtPesquisaMat, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btnVoltarConsRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarConsRespActionPerformed
        TelaMaterias t = new TelaMaterias();
        t.setVisible(true);
        dispose();
    ...
    private void btPesquisaRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisaRespActionPerformed
        btconsulta(txtPesquisaMat.getText());
    ...
    private void txtPesquisaMatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPesquisaMatActionPerformed
        if (txtPesquisaMat.getText().isBlank()) {
            consultainicial();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsMateria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsMateria().setVisible(true);
            }
        });
    }
