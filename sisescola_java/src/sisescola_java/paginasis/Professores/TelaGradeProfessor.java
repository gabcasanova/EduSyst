 ...
 * @author Matheus
 */
public class TelaGradeProfessor extends javax.swing.JFrame {
    ...
    private void carregarProfessoresHorarios() throws ClassNotFoundException {
        ...
        String sql = "SELECT horarios.Dia_Semana, horarios.Turno, horarios.Inicio, horarios.Fim, "
                + "materias.Nome AS Nome_Materia, turmas.Classe, professores.Nome AS Nome_Professor "
                + "FROM Professores "
    ...
    private void initComponents() {
        ...
        lblNomeP.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblNomeP.setForeground(new java.awt.Color(2, 48, 71));
        lblNomeP.setText("Nome do Professor:");
                ...
                .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jButton1)
                            .addComponent(lblNomeP, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                        .addGap(353, 353, 353)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "SELECT horarios.Dia_Semana, horarios.Turno, horarios.Inicio, horarios.Fim, "
                ...
                + "INNER JOIN Materias ON Materias.Id_Materia = Horarios_Materias.Materia_ID "
                + "INNER JOIN Turmas ON Turmas.Id_Turma = Horarios_Materias.Turma_ID "
                + "WHERE Professores.CPF LIKE ? OR Professores.Nome LIKE ?";
        ...
        try (Connection con = ConnectionFactory.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            // Limpa a tabela antes de carregar os novos resultados
            modeloTabela.setRowCount(0);

            boolean found = false;
            while (rs.next()) {
                if (!found) {
                    lblNomeP.setText(rs.getString("Nome_Professor")); // Define o nome do professor na label
                    found = true;
                }
                modeloTabela.addRow(new Object[]{
            ...
            if (!found) {
                lblNomeP.setText("Professor não encontrado."); // Exibe mensagem se não encontrar o professor
            }
        } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGradeProfessor.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGradeProfessor().setVisible(true);
            }
        });
    }
