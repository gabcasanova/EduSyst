...
public class TelaAltProf extends javax.swing.JFrame {
    ...
    public void btconsulta(String pesquisa) {
        ...
        try {
            ...
            if (pesquisa.matches("\\d{11}")) {
                // Consulta pelo CPF
                for (Professor P : adao.btconsultar(null, pesquisa)) {

                    txtCPFAA.setText(P.getCPFp());
                    txtNomeAA.setText(P.getNomep());
                    txtEmailAA.setText(P.getEmailp());
                    txtSenhaAA.setText("");
                    if (P.getData_Nascp() != null) {
                        LocalDate data = LocalDate.parse(P.getData_Nascp(), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
                    ...
                    txtEnderecoAA.setText(P.getEnderecop());
                    txtTelefoneAA.setText(P.getTelefonep());
                    boxGeneroP.setSelectedItem(String.valueOf(P.getGenerop()));
                }
            } else {
                // Consulta pelo Nome
                for (Professor P : adao.btconsultar(pesquisa, null)) {
    ...
    private void initComponents() {
        ...
        boxGeneroP = new javax.swing.JComboBox<>();
        ...
        boxGeneroP.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                boxGeneroPMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                boxGeneroPMouseExited(evt);
            }
        });
        boxGeneroP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boxGeneroPActionPerformed(evt);
            }
        });
        ...
        btAlterarP.setToolTipText("Alterar");
        btAlterarP.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 5, true));
        ...
        jLabel12.setText("ALTERAR PROFESSOR");
                    ...
                    .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                        .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(boxGeneroP, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlPrincipalCLayout.createSequentialGroup()
                                .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(btAlterarP, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                                .addGap(89, 89, 89))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlPrincipalCLayout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlPrincipalCLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(pnlPrincipalCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(boxGeneroP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel3)))
                            .addGroup(pnlPrincipalCLayout.createSequentialGroup()
                                .addComponent(jLabel12)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btAlterarP, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel13)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void boxGeneroPMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_boxGeneroPMouseEntered
        boxGeneroP.setForeground(new Color(251, 133, 0));
    }//GEN-LAST:event_boxGeneroPMouseEntered

    private void boxGeneroPMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_boxGeneroPMouseExited
        boxGeneroP.setForeground(new Color(2, 48, 71));
    }//GEN-LAST:event_boxGeneroPMouseExited
    ...
    private void btAlterarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarPActionPerformed
        ...
        if (txtCPFAA.getText().equals("")
            ...
            p.setCPFp(txtCPFAA.getText());
        }

        p.setNomep(txtNomeAA.getText());
        p.setEmailp(txtEmailAA.getText());
        p.setSenhap(txtSenhaAA.getText());
        ...
        try {
            ...
            if (dia > 31 || dia == 0) {
                ...
                p.setData_Nascp(dataFormatada); // Use Data_Nascp consistentemente
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Dia, mês e ano devem ser números válidos.");
            return;
        }
        p.setEnderecop(txtEnderecoAA.getText());
        p.setTelefonep(txtTelefoneAA.getText());
        p.setGenerop(boxGeneroP.getSelectedItem().toString());
        try {
            if (txtSenhaAA.getText().isBlank() || txtSenhaAA.getText().isEmpty()) {
                dao.AtualizarProfSemSenha(p);
            } else {
                dao.AtualizarProfComSenha(p);
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TelaCadAluno.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Erro ao atualizar professor: Classe não encontrada.");
        } catch (SQLException ex) {
            Logger.getLogger(TelaCadAluno.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Erro ao atualizar professor: SQL exception.");
        }
    ...
    private void boxGeneroPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxGeneroPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_boxGeneroPActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAltProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAltProf().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> boxGeneroP;
