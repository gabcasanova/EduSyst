...
public class AlunoObterMat extends AsyncTask<Integer, Void, String> {

    private Context context;
    private TableLayout tableLayout;

    public AlunoObterMat(Context context, TableLayout tableLayout) {
    ...
    protected String doInBackground(Integer... params) {
        ...
        try {
            URL url = new URL("http://10.0.2.2/sisescola_web_android/aluno_obtermateria.php?id_aluno=" + idAluno);
    ...
    protected void onPostExecute(String result) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                nameView.setText(jsonObject.getString("materia_nome"));
