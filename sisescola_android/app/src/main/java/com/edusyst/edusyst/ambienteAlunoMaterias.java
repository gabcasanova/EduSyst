...
public class AmbienteAlunoMaterias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambiente_aluno_materias);
        ...
        // Toolbar
        Toolbar tb_alunoMat = findViewById(R.id.tb_alunoMat);
        setSupportActionBar(tb_alunoMat);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setDisplayShowHomeEnabled(true);

            tb_alunoMat.getNavigationIcon().setTint(ContextCompat.getColor(this, R.color.white)); // Mudar cor do botão de voltar
        }
        ...
        TableLayout tl_mat = findViewById(R.id.tl_mat);
        new AlunoObterMat(this, tl_mat).execute(idAluno);
    }
