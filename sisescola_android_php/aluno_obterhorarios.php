<?php
    ...
    $sql = "select horarios.Dia_Semana as dia_semana, horarios.Turno as turno, horarios.Inicio as inicio, horarios.Fim as fim, "
            . "materias.Nome as materia_nome, professores.Nome as professor_nome, turmas.Classe as turma_classe "
            . "from professores "
